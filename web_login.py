...
class my_login:
    ...
    def __init__(self, username,pwd,cookie_file):#初始化urllib.request，引入cookie
        self.uname = username
        self.passwd = pwd
        ...
        self.opener = urllib.request.build_opener(cookie_support, self.encoding_support,urllib.request.HTTPHandler)
        urllib.request.install_opener(self.opener)#设置 urllib.request 的全局 opener
    ...
    def do_weibo_login(self):#RSA加密直接登录
        ...
        self.uname = urllib.request.quote(self.uname) #url格式编码
    ...
    def weibo_login(self):#使用cookie登录,可以解决验证码问题
        ...
        if os.path.exists(self.cookie_file):
            ...
            fileChrome = r'C:/Users/i304905/AppData/Local/Google/Chrome/User Data/Default/Cookies'#XXXX换为你的用户名win7
